        ...
        <form action="<?php echo e(route('accounts.store')); ?>" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="highest_rank" class="w-full p-2 rounded-md bg-[#25253b] border border-gray-600 focus:ring-2 focus:ring-purple-500">
                        ...
                        <?php $__currentLoopData = $highestRanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                <div class="flex justify-between items-center mb-2">
                    <label class="block text-sm">Select Heroes (<?php echo e(count($heroes)); ?> heroes available)</label>
